...
export const updateCoursebase = (courseId, params) => {
  return http.requestPut(apiUrl + '/course/update/' + courseId, params)
}

// 查询课程营销信息
export const getCourseMarketById = courseId => {
  return http.requestQuickGet(apiUrl + '/course/getMarketView/' + courseId)
}

//更新课程营销信息
export const updateCourseMarket = (courseId, params) => {
  return http.requestPut(apiUrl + '/course/updateCourseMarket/' + courseId, params)
}
